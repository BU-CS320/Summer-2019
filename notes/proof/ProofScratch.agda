...
gteSucc .(succ a) m (greaterThanByOne a .m nm) = greaterThanByOne (succ a) (succ m) (gteSucc a m nm)


transitive : (a : Nat) -> (b : Nat) -> (c : Nat) -> (GTE a b) -> (GTE b c) -> (GTE a c)
transitive a .a c (eqItself .a) bc = bc
transitive .(succ a) b c (greaterThanByOne a .b ab) bc = greaterThanByOne a c (transitive a b c ab bc)
