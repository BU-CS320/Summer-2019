...
instance Monad (PrinterMonad out) where
  ...
  (PrinterMonad ls a) >>= f = case (f a) of
    PrinterMonad ls' b -> PrinterMonad (ls ++ ls') b

-- f :: a -> PrinterMonad out b (bound at src\PrinterMonad.hs:33:27)
-- a :: a (bound at src\PrinterMonad.hs:33:20)
-- ls :: [out] (bound at src\PrinterMonad.hs:33:17)
